  ...
  return (
    <div id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60 mx-auto max-w-4xl">
            <span className="text-[#BDD9BF]">Create, Explore, Expand, Conquer.</span>
          </h1>

          <p className="mx-auto max-w-2xl text-base sm:text-lg leading-7 sm:leading-8 text-zinc-300 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto bg-black no-underline group cursor-pointer relative shadow-2xl shadow-[#BDD9BF]/10 rounded-full p-px text-sm font-semibold leading-6 text-white inline-block"
            >
              ...
              <div className="relative flex space-x-2 items-center justify-center z-10 rounded-full bg-black py-2.5 sm:py-3 px-4 sm:px-6 ring-1 ring-white/10">
                <span>Join Us</span>
        ...
        >
          ...
          <div className="rounded-xl border border-white/10 bg-black/40 backdrop-blur-xl p-3 sm:p-4 max-w-4xl mx-auto text-left">
